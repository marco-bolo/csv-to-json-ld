...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/License.csv out/validation/person-or-organization.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/License.csv data/Taxon.csv data/Place.csv data/PropertyValue.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv out/validation/person-or-organization.csv data/DataDownload.csv data/Audience.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/License.csv data/Taxon.csv data/Place.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv out/validation/person-or-organization.csv data/Audience.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/SoftwareSourceCode.csv data/SoftwareApplication.csv data/Instrument.csv data/HowToStep.csv data/HowToTip.csv data/Service.csv out/validation/person-or-organization.csv data/Platform.csv data/Document.csv data/Audience.csv out/validation
