...
out/validation/Action-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/HowTo.csv data/Action.csv data/Dataset.csv out/validation
...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/License.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/PropertyValue.csv data/DataDownload.csv data/EmbargoStatement.csv data/Audience.csv data/Place.csv data/Taxon.csv out/validation/person-or-organization.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/Audience.csv data/Place.csv data/Taxon.csv out/validation/person-or-organization.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/HowToStep.csv data/Audience.csv data/HowToTip.csv out/validation/person-or-organization.csv data/Service.csv data/SoftwareApplication.csv data/SoftwareSourceCode.csv out/validation
