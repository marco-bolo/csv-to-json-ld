...
out/validation/Action-csv-list-column-foreign-key.success.log: data/Action.csv out/validation/person-or-organization.csv data/HowTo.csv data/Dataset.csv out/validation
...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/Audience.csv data/License.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/PropertyValue.csv data/DataDownload.csv data/Audience.csv data/License.csv out/validation/person-or-organization.csv data/EmbargoStatement.csv data/PublishingStatusDefinedTerm.csv data/Taxon.csv data/Place.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/Audience.csv data/License.csv out/validation/person-or-organization.csv data/EmbargoStatement.csv data/PublishingStatusDefinedTerm.csv data/Taxon.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/SoftwareSourceCode.csv data/SoftwareApplication.csv data/Audience.csv data/Service.csv out/validation/person-or-organization.csv data/Instrument.csv data/HowToStep.csv data/Platform.csv data/HowToTip.csv data/Document.csv out/validation
...
out/validation/HowToTip-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation
	...
	@echo ""
out/validation/Instrument-csv-list-column-foreign-key.success.log: data/Platform.csv out/validation/person-or-organization.csv data/Document.csv out/validation
...
out/validation/Place-csv-list-column-foreign-key.success.log: data/GeoShape.csv out/validation
	...
	@echo ""
out/validation/Platform-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Organization.csv data/Document.csv out/validation
