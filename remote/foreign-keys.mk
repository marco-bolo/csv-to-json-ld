...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/License.csv out/validation/person-or-organization.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/PropertyValue.csv data/PublishingStatusDefinedTerm.csv data/Place.csv data/Audience.csv data/DataDownload.csv data/License.csv data/Taxon.csv data/EmbargoStatement.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/Place.csv data/Audience.csv data/License.csv data/Taxon.csv data/EmbargoStatement.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/SoftwareSourceCode.csv data/Service.csv out/validation/person-or-organization.csv data/HowToStep.csv data/Audience.csv data/HowToTip.csv data/SoftwareApplication.csv out/validation
