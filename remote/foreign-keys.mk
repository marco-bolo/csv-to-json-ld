...
out/validation/Action-csv-list-column-foreign-key.success.log: data/Dataset.csv data/HowTo.csv data/Action.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv data/License.csv data/Audience.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/License.csv data/Audience.csv out/validation/person-or-organization.csv data/DataDownload.csv data/PublishingStatusDefinedTerm.csv data/PropertyValue.csv data/Taxon.csv data/Place.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/License.csv data/Audience.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/Taxon.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Platform.csv data/SoftwareApplication.csv data/HowToStep.csv data/HowToTip.csv data/Document.csv data/SoftwareSourceCode.csv data/Service.csv out/validation/person-or-organization.csv data/Audience.csv data/Instrument.csv out/validation
...
out/validation/HowToTip-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation
	...
	@echo ""
out/validation/Instrument-csv-list-column-foreign-key.success.log: data/Platform.csv data/Document.csv out/validation/person-or-organization.csv out/validation
...
out/validation/MonetaryGrant-csv-list-column-foreign-key.success.log: data/Organization.csv out/validation
	...
	@echo ""
out/validation/Organization-csv-list-column-foreign-key.success.log: data/Organization.csv data/ContactPoint.csv data/MonetaryGrant.csv out/validation
...
out/validation/Place-csv-list-column-foreign-key.success.log: data/GeoShape.csv out/validation
	...
	@echo ""
out/validation/Platform-csv-list-column-foreign-key.success.log: data/Organization.csv data/Document.csv out/validation/person-or-organization.csv out/validation
