...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/License.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/PropertyValue.csv out/validation/person-or-organization.csv data/DataDownload.csv data/EmbargoStatement.csv data/Audience.csv data/License.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/Place.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/EmbargoStatement.csv data/Audience.csv data/License.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/SoftwareSourceCode.csv data/Audience.csv data/Instrument.csv data/Document.csv data/HowToTip.csv data/Service.csv data/HowToStep.csv data/SoftwareApplication.csv data/Platform.csv out/validation
...
out/validation/HowToTip-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation
	...
	@echo ""
out/validation/Instrument-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Document.csv data/Platform.csv out/validation
...
out/validation/MonetaryGrant-csv-list-column-foreign-key.success.log: data/Organization.csv out/validation
	...
	@echo ""
out/validation/Organization-csv-list-column-foreign-key.success.log: data/MonetaryGrant.csv data/ContactPoint.csv data/Organization.csv out/validation
...
out/validation/Place-csv-list-column-foreign-key.success.log: data/GeoShape.csv out/validation
	...
	@echo ""
out/validation/Platform-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Document.csv data/Organization.csv out/validation
