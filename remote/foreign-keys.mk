...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/License.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/Audience.csv data/Taxon.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/DataDownload.csv data/License.csv data/Place.csv data/PropertyValue.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/Audience.csv data/EmbargoStatement.csv data/Taxon.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/License.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Audience.csv data/Service.csv out/validation/person-or-organization.csv data/HowToStep.csv data/HowToTip.csv data/SoftwareSourceCode.csv data/SoftwareApplication.csv out/validation
