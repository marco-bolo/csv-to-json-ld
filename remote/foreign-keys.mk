...
out/validation/Action-csv-list-column-foreign-key.success.log: data/HowTo.csv data/Dataset.csv out/validation/person-or-organization.csv data/Action.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/Audience.csv data/License.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/DataDownload.csv data/PropertyValue.csv data/PublishingStatusDefinedTerm.csv data/Taxon.csv out/validation/person-or-organization.csv data/Place.csv data/License.csv data/Audience.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/PublishingStatusDefinedTerm.csv data/Taxon.csv out/validation/person-or-organization.csv data/Place.csv data/License.csv data/Audience.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/HowToStep.csv data/SoftwareSourceCode.csv data/Platform.csv data/SoftwareApplication.csv data/Service.csv data/Instrument.csv out/validation/person-or-organization.csv data/Document.csv data/HowToTip.csv data/Audience.csv out/validation
