...
out/validation/Action-csv-list-column-foreign-key.success.log: data/Document.csv data/Action.csv out/validation/all-identifiers.csv data/HowTo.csv out/validation/person-or-organization.csv data/Dataset.csv out/validation
...
out/validation/Audience-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/License.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/PropertyValue.csv data/DataDownload.csv out/validation/all-identifiers.csv data/PublishingStatusDefinedTerm.csv data/License.csv out/validation/person-or-organization.csv data/Place.csv data/Audience.csv data/Taxon.csv out/validation
...
out/validation/DefinedTermSet-csv-list-column-foreign-key.success.log: out/validation/any-defined-term.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv out/validation/all-identifiers.csv data/PublishingStatusDefinedTerm.csv data/License.csv out/validation/person-or-organization.csv data/Place.csv data/Audience.csv data/Taxon.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Instrument.csv data/Document.csv data/Platform.csv data/SoftwareSourceCode.csv data/SoftwareApplication.csv data/Service.csv out/validation/person-or-organization.csv data/HowToTip.csv data/Audience.csv data/HowToStep.csv out/validation
...
out/validation/HowToTip-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation
	...
	@echo ""
out/validation/Instrument-csv-list-column-foreign-key.success.log: data/Platform.csv out/validation/all-identifiers.csv out/validation/person-or-organization.csv data/Document.csv out/validation
...
out/validation/MonetaryGrant-csv-list-column-foreign-key.success.log: data/Organization.csv out/validation
	...
	@echo ""
out/validation/Organization-csv-list-column-foreign-key.success.log: data/ContactPoint.csv out/validation/all-identifiers.csv data/Organization.csv data/MonetaryGrant.csv out/validation
...
out/validation/Place-csv-list-column-foreign-key.success.log: data/GeoShape.csv out/validation
	...
	@echo ""
out/validation/Platform-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv data/Organization.csv out/validation/person-or-organization.csv data/Document.csv out/validation
	...
	@echo ""
out/validation/PropertyValue-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv data/PropertyValue.csv out/validation
...
out/validation/Service-csv-list-column-foreign-key.success.log: data/Place.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/SoftwareApplication-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv out/validation
