...
out/validation/Action-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Action.csv data/HowTo.csv data/Dataset.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/License.csv data/PublishingStatusDefinedTerm.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/DataDownload.csv data/Audience.csv data/PropertyValue.csv data/Place.csv data/License.csv data/EmbargoStatement.csv data/Taxon.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/Audience.csv data/Place.csv data/License.csv data/EmbargoStatement.csv data/Taxon.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Platform.csv data/HowToStep.csv data/SoftwareApplication.csv data/Audience.csv data/Instrument.csv data/HowToTip.csv data/SoftwareSourceCode.csv data/Service.csv out/validation
