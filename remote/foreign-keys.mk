...
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/License.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/Audience.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/PropertyValue.csv data/License.csv data/PublishingStatusDefinedTerm.csv data/Place.csv data/Audience.csv data/EmbargoStatement.csv data/Taxon.csv out/validation/person-or-organization.csv data/DataDownload.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/License.csv data/PublishingStatusDefinedTerm.csv data/Place.csv data/Audience.csv data/EmbargoStatement.csv data/Taxon.csv out/validation/person-or-organization.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Service.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/SoftwareSourceCode.csv data/HowToStep.csv data/HowToTip.csv data/SoftwareApplication.csv data/Audience.csv out/validation/person-or-organization.csv data/Service.csv out/validation
