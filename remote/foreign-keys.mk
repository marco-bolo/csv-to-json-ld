...
out/validation/Action-csv-list-column-foreign-key.success.log: data/HowTo.csv out/validation/person-or-organization.csv data/Document.csv out/validation/all-identifiers.csv data/Action.csv data/Dataset.csv out/validation
...
out/validation/Audience-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Audience.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Audience.csv data/License.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv out/validation/all-identifiers.csv data/PropertyValue.csv data/Place.csv data/DataDownload.csv out/validation
...
out/validation/DefinedTermSet-csv-list-column-foreign-key.success.log: out/validation/any-defined-term.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Audience.csv data/License.csv data/Taxon.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv out/validation/all-identifiers.csv data/Place.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/SoftwareSourceCode.csv data/Audience.csv data/Document.csv data/HowToStep.csv data/HowToTip.csv data/Service.csv data/Instrument.csv data/Platform.csv data/SoftwareApplication.csv out/validation
...
out/validation/HowToTip-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation
	...
	@echo ""
out/validation/Instrument-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv data/Platform.csv out/validation/person-or-organization.csv data/Document.csv out/validation
...
out/validation/MonetaryGrant-csv-list-column-foreign-key.success.log: data/Organization.csv out/validation
	...
	@echo ""
out/validation/Organization-csv-list-column-foreign-key.success.log: out/validation/all-identifiers.csv data/Organization.csv data/MonetaryGrant.csv data/ContactPoint.csv out/validation
