...
out/validation/Action-csv-list-column-foreign-key.success.log: data/HowTo.csv data/Dataset.csv data/Action.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/Audience.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/DataDownload.csv data/PropertyValue.csv data/EmbargoStatement.csv data/License.csv data/Taxon.csv data/Place.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/EmbargoStatement.csv data/License.csv data/Taxon.csv data/Place.csv data/Audience.csv data/PublishingStatusDefinedTerm.csv out/validation/person-or-organization.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/HowToStep.csv data/Service.csv data/Platform.csv data/Audience.csv data/Instrument.csv data/SoftwareApplication.csv data/HowToTip.csv data/Document.csv data/SoftwareSourceCode.csv out/validation/person-or-organization.csv out/validation
...
out/validation/MonetaryGrant-csv-list-column-foreign-key.success.log: data/Organization.csv out/validation
	...
	@echo ""
out/validation/Organization-csv-list-column-foreign-key.success.log: data/MonetaryGrant.csv data/Organization.csv data/ContactPoint.csv out/validation
...
out/validation/Place-csv-list-column-foreign-key.success.log: data/GeoShape.csv out/validation
	...
	@echo ""
out/validation/Platform-csv-list-column-foreign-key.success.log: data/Document.csv data/Organization.csv out/validation/person-or-organization.csv out/validation
