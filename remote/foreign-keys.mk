...
out/validation/Action-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv data/Action.csv data/Dataset.csv data/HowTo.csv out/validation
	...
	@echo ""
out/validation/DataDownload-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation/person-or-organization.csv data/License.csv data/PublishingStatusDefinedTerm.csv out/validation
	...
	@echo ""
out/validation/Dataset-csv-list-column-foreign-key.success.log: data/Audience.csv data/DataDownload.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv data/Place.csv data/License.csv data/Taxon.csv data/PropertyValue.csv out/validation
...
out/validation/DatasetComment-csv-list-column-foreign-key.success.log: out/validation/person-or-organization.csv out/validation
	...
	@echo ""
out/validation/Document-csv-list-column-foreign-key.success.log: data/Audience.csv out/validation/person-or-organization.csv data/PublishingStatusDefinedTerm.csv data/EmbargoStatement.csv data/Place.csv data/License.csv data/Taxon.csv out/validation
...
out/validation/HowTo-csv-list-column-foreign-key.success.log: data/Document.csv out/validation
	...
	@echo ""
out/validation/HowToStep-csv-list-column-foreign-key.success.log: data/Audience.csv data/Instrument.csv data/Service.csv out/validation/person-or-organization.csv data/SoftwareSourceCode.csv data/Document.csv data/Platform.csv data/HowToTip.csv data/SoftwareApplication.csv data/HowToStep.csv out/validation
